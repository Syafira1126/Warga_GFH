...
export class ApiService {
  ...
  async login(username: string, password: string) {
    try {
      ...
      if (res.data.status == 'Ok') {
        ...
        return 'unexpectedStatus'; // Menangani status tidak diharapkan
      }
    } catch (err) {
        return 'err';
    }
  ...
  async getPayment(kd: string, year: string, jenis: string) {
    ...
    // Tambahkan blok else untuk menangani kondisi "notFound" di sini
    return {
      msg: 'notFound',
    };
  }
  ...
  async getPesan(kd_pnddk: string) {
    try {
      ...
      if (res.data.status == 'Ok') {
        ...
        // Tambahkan blok else untuk menangani kondisi selain 'Ok' dan 'Not Found'
        return {
          msg: 'unknownStatus',
        };
      }
  ...
  async register(data: any) {
    try {
      ...
      if (res.data.status == 'Ok') {
        ...
        // Tambahkan blok else untuk menangani kondisi selain yang sudah dihandle di atas
        return {
          msg: 'unknownStatus',
        };
      }
  ...
  async insertIuran(data: any) {
    try {
      ...
      // Menambahkan return default jika tidak ada kondisi yang sesuai
      return {
        msg: 'unknownError',
      };
    } catch (err: any) {
