...
@Component({
  selector: 'app-d-lain',
  templateUrl: './d-lain.page.html',
  styleUrls: ['./d-lain.page.scss'],
})
export class DLainPage{
      ...
      if (val == null) {
        ...
        if(this.searchYear == ''){
          this._apiService.getKeluarga(val).then((res)=>{
            this._apiService.getPayment(res.data.kd_blok, this.currentYear, 'Lainnya').then((res) => {
              if (res.msg == 'ok') {
                this.Data = res.data;
                loader.dismiss();
                this.presentToast(
          ...
          this._apiService.getKeluarga(val).then((res)=>{
            this._apiService.getPayment(res.data.kd_blok, this.searchYear, 'Lainnya').then((res) => {
              if (res.msg == 'ok') {
                this.Data = res.data;
                loader.dismiss();
                this.presentToast(
